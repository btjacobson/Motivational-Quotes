...
import com.example.android.motivationalquotes.data.QuoteData;
import com.example.android.motivationalquotes.data.QuoteListAsyncResponse;
import com.example.android.motivationalquotes.data.QuoteViewPagerAdapter;
            ...
            public void processFinished(ArrayList<Quote> quotes) {
                for (int i = 0; i < quotes.size(); i++) {
                    QuoteFragment quoteFragment = QuoteFragment.newInstance
                            (quotes.get(i).getQuote(), quotes.get(i).getAuthor());
